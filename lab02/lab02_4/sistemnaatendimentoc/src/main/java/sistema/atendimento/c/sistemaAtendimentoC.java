...
public class sistemaAtendimentoC {
    ...
    public sistemaAtendimentoC(int limiteDeCompras, long tempoLimite) {
    ...
    //add user
    public void loginOrRegisterUser(MongoCollection<Document> users, String nome) {
        try {
    ...
    public void comprarProduto(MongoCollection<Document> users) {
        ...
        try {
            //da me um nome de produto random
            Random random = new Random();
            String nomeProduto = "Produto" + random.nextInt(1000);
